...
net_file = '/home/guo/zpy/Siamese-RPN-pytorch-master/dataset/weight/High-Low-two.pth.tar'
rgbdnet = RGBDNET().cuda()
checkpoint = torch.load(net_file)
rgbdnet.load_state_dict(checkpoint['state_dict'])

with open('/media/guo/Program/PTB_dataset/all_init_bbox.txt', 'r') as f1:
    lines = f1.readlines()
...
gt_bbox_ = [int(i) for i in sequence_gt[args.sequence].strip('\n').split(',')]

s = os.path.join('/home/guo/zpy/Mypysot/mypysot/result/result4', name)
if not os.path.exists(s):
    os.makedirs(s)
with open(os.path.join(s, name+'.txt'), 'w') as f2:
    f2.write(str(gt_bbox_[0]) + ',' +
             str(gt_bbox_[1]) + ',' +
             str(gt_bbox_[0]+gt_bbox_[2]) + ',' +
             str(gt_bbox_[1]+gt_bbox_[3]))
    f2.write('\n')

image_file1 = '/media/guo/Program/PTB_dataset/' + name + '/rgb/00000001.png'
image_file2 = '/media/guo/Program/PTB_dataset/' + name + '/depth/00000001.png'
print(image_file1)
...
for i in range(2,5000):
    ...
    image_file1 = '/media/guo/Program/PTB_dataset/' + name + '/rgb/'
    image_file1 = image_file1 + str(i).zfill(8) + '.png'
    #image_file2 = '/media/guo/Program/PTB_dataset/' + name + '/depth/'
    ...
    image_file_rgb= '/media/guo/Program/PTB_dataset/' + name +'/rgb/' + str(i).zfill(8) + '.png'
    image_file_d='/media/guo/Program/PTB_dataset/' + name + '/depth/' + str(i).zfill(8) + '.png' 
    ...
    print("_pick_img_pairs used:",elapsed)
