...
'''2020.2.24 ablation study. Use Depth-wise correlation'''
...
import ltr.models.SEbcm.SEbcm as SEbcm
...
def run(settings):
    ...
    settings.batch_size = 32  # Batch size 32
    ...
    # Create network
    '''use SEbcm_resnet50_Depth model'''
    net = SEbcm.SEbcm_resnet50_Depth(backbone_pretrained=True,used_layers=settings.used_layers,
    ...
    actor = actors.SEbcm_Actor(net=net, objective=objective)
