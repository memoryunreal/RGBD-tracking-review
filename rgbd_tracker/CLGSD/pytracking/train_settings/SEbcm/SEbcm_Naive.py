...
'''2020.2.24 ablation study. Use Naive correlation'''
...
def run(settings):
    ...
    # Create network
    '''use SEbcm_resnet50_Naive model'''
    net = SEbcm.SEbcm_resnet50_Naive(backbone_pretrained=True,used_layers=settings.used_layers,
