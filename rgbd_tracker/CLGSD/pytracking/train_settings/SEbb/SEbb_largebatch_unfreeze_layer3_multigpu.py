...
def run(settings):
    ...
    # print('multiple GPU:',multigpu.is_multi_gpu(net))
    # print(type(net))
    # print(type(net.module))
    actor = actors.SEbb_anchor_Actor(net=net, objective=objective)
    # Optimizer
    '''##### 注意如果要改待优化的参数的话,这块也需要改 #####'''
    # optimized_module = nn.Sequential(net.module.feature_extractor.layer3,
    #                                  net.module.neck, net.module.head)
