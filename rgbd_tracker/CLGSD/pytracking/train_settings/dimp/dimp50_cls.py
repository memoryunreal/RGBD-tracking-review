...
from ltr.models.tracking import dimpclsnet
...
def run(settings):
    ...
    dataset_train = sampler.DiMPSampler([lasot_train, got10k_train, coco_train],
                                        [0.25,1,1],
    ...
    dataset_val = sampler.DiMPSampler([lasot_test], [1], samples_per_epoch=5000, max_gap=30,
    ...
    '''new net'''
    net = dimpclsnet.dimpclsnet50(filter_size=settings.target_filter_sz, backbone_pretrained=True, optim_iter=5,
    ...
    loss_weight = {'test_clf': 100, 'test_init_clf': 100, 'test_iter_clf': 400}
    '''new actor'''
    actor = actors.DiMP_cls_Actor(net=net, objective=objective, loss_weight=loss_weight)
