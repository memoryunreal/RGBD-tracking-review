...
'''2020.2.22 train a two branch-selector to choose the best result'''
...
'''newly added'''
from ltr.models.selector.selector import branch_selector_bc
from pytracking.utils.loading import load_network
from ltr.actors.selector_bc import Selector_bc_Actor
import os
...
def run(settings):
    ...
    settings.max_gap = 50
    settings.sample_per_epoch_train = 200 # 200
    settings.sample_per_epoch_val = 50 # 50
    ...
    # Create network
    checkpoint_root = '/home/masterbin-iiau/Desktop/scale-estimator/ltr/checkpoints/ltr/SEbc/'
    '''2020.2.22 for SEbc model'''
    model_name = 'SEbc'
    ...
    '''create selector'''
    selector = branch_selector_bc()
    selector.cuda()
    # Set objective
    objective = nn.CrossEntropyLoss()
    # Create actor, which wraps network and objective
    actor = Selector_bc_Actor(refine_net=net, selector=selector, objective=objective)
