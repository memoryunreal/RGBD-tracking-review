...
Related papers will be continuously updated. Please feel free to contact [jinyu.yang96@outlook.com](mailto:jinyu.yang96@outlook.com), [zhe.li.cs@outlook.com](mailto:zhe.li.cs@outlook.com).
...
## :rocket: News
:boom: [Track-Anything](https://github.com/gaomingqi/Track-Anything) Development Underway: Give it a Try Now!
...
### 2023
 * **ViPT**: Jiawen Zhu, Simiao Lai, Xin Chen, Dong Wang, Huchuan Lu. Visual Prompt Multi-Modal Tracking. In _CVPR_, 2023. [[Paper]](https://arxiv.org/abs/2303.10826) [[Code]](https://github.com/jiawen-zhu/ViPT).
 ...
 * **ProTrack**: Jinyu Yang, Zhe Li, Feng Zheng, Aleš Leonardis, Jingkuan Song. Prompting for Multi-Modal Tracking. In _ACMMM_, 2022. [[Paper]](https://arxiv.org/abs/2207.14571) 
 ...
 * **RGBD1K**: Xue-Feng Zhu, Tianyang Xu, Zhangyong Tang, Zucheng Wu, Haodong Liu, Xiao Yang, Xiao-Jun Wu, Josef Kittler. RGBD1K: A Large-scale Dataset and Benchmark for RGB-D Object Tracking. In _AAAI_, 2023. [[Paper]](https://arxiv.org/pdf/2208.09787.pdf)
